  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Recensioni: i voti sui dieci criteri, l'eventuale commento, le informazioni fattuali che indichi e il periodo di visita dichiarato.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Reviews: your scores across the ten criteria, any comment, the factual information you report and the visit period you declare.",
